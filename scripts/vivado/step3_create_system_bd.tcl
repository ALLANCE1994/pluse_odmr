...
set rtl_dir   [file join $proj_root "hardware" "pl"]
set xdc_dir   [file join $proj_root "hardware" "constraints"]
set sim_dir   [file join $proj_root "simulation" "testbenches"]
...
foreach f [lsort [glob -nocomplain {*}[glob -directory $rtl_dir -type d *]/*.v]] {
