...
$Steps = @(
    @{Id="step1"; Script="vivado/step1_ip_package.tcl";      Desc="IP Package (pulse_odmr_ip)"},
    @{Id="step2"; Script="vivado/step2_setup_project.tcl";     Desc="Project Setup"},
    @{Id="step3"; Script="vivado/step3_create_system_bd.tcl";   Desc="Block Design (PS7+AXI+IP)"},
    @{Id="step4"; Script="vivado/step4_generate_outputs.tcl";   Desc="Generate Outputs (Wrapper)"},
    @{Id="step5"; Script="vivado/step5_run_subsystem_sim.tcl";  Desc="Subsystem Simulation"},
    @{Id="step6"; Script="vivado/step6_run_impl.tcl";           Desc="Synthesis + Implementation"},
    @{Id="step7"; Script="vivado/step7_run_phase3_checks.tcl";  Desc="Phase 3 Gate Checks"}
)
